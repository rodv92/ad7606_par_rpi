...
sudo sh -c "cat /sys/bus/iio/devices/trigger0/name > /sys/bus/iio/devices/iio\:device0/trigger/current_trigger"
sudo sh -c "echo 1 > /sys/bus/iio/devices/iio\:device0/scan_elements/in_voltage0_en"
cat /sys/bus/iio/devices/iio\:device0/in_voltage0_raw
cat /sys/bus/iio/devices/iio\:device0/in_voltage0_raw
#sudo vclog -m

#sudo sh -c "dd if=/dev/iio\:device0 bs=2 iflag=fullblock count=100 | hexdump"
